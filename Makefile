...
# Description   : This the Makefile  for  register file of the vector processor to test it separately
# Date         : 19 Sep, 2024.



SOURCES_SV :=  ../../src/vec_regfile.sv \
				vec_regfile_tb.sv 

SOURCES_CPP := vec_regfile_tb.cpp
