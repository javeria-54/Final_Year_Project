...
//                FETCH MODULE
// ============================================================
(* keep_hierarchy = "yes" *)  fetch fetch_module (
    .rst_n        (rst_n),
    .clk          (clk),
    .if2mem_o     (if2mem),
    .mem2if_i     (mem2if),
...
logic inst_is_mem;
(* keep_hierarchy = "yes" *)  decode decode_module (
    .rst_n           (rst_n),
    .clk             (clk),
    .is_vector       (is_vector),
...
(* keep_hierarchy = "yes" *)  execute execute_module (
    .rst_n                   (rst_n),
    .clk                     (clk),
...
(* keep_hierarchy = "yes" *)  lsu lsu_module (
    .rst_n                      (rst_n),
    .clk                        (clk),
...
(* keep_hierarchy = "yes" *)  writeback writeback_module (
    .rst_n                      (rst_n),
    .clk                        (clk),
...
(* keep_hierarchy = "yes" *) forward_stall forward_stall_module (
    .rst_n      (rst_n),
    .clk        (clk),
    .wrb2fwd_i  (wrb2fwd),
    .lsu2fwd_i  (lsu2fwd),
...
(* keep_hierarchy = "yes" *) divide divide_module (
    .rst_n           (rst_n),
    .clk             (clk),
    .exe2div_i       (exe2div),
...
(* keep_hierarchy = "yes" *) amo amo_module (
    .rst_n          (rst_n),
    .clk            (clk),
...
(* keep_hierarchy = "yes" *)  reorder_buffer rob (
    .clk                (clk),
    .reset              (rst_n),
...
//                VECTOR PROCESSOR
// ============================================================
(* keep_hierarchy = "yes" *) vector_processor vector (
    .clk                (clk),
    .reset              (rst_n),
...
// ============================================================
(* keep_hierarchy = "yes" *) val_ready_controller val_ready (
    .clk             (clk),
    .reset           (rst_n),
...
//          DBUS INTERCONNECT
// ============================================================
(* keep_hierarchy = "yes" *) dbus_interconnect dbus (
    .rst_n        (rst_n),
    .clk          (clk),
    .lsu2dbus_i   (lsu2dbus),
    .dbus2lsu_o   (dbus2lsu),
