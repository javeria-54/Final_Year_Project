...
function [15:0] csa_3to2(input [7:0] a, b, c);
    reg [7:0] sum, carry;
    begin
        sum   = a ^ b ^ c;
        carry = (a & b) | (b & c) | (a & c);
...
function [9:0] add_sum_carry(input [7:0] sum, carry);
...
module top_8(
    ...
    (* DONT_TOUCH = "yes" *)
    (* keep = "true" *) dadda_8 dadda_1 (.A(mult1_A), .B(mult1_B), .y(mult_out_1));
    (* keep = "true" *) dadda_8 dadda_2 (.A(mult2_A), .B(mult2_B), .y(mult_out_2));
    (* keep = "true" *) dadda_8 dadda_3 (.A(mult3_A), .B(mult3_B), .y(mult_out_3));
    (* keep = "true" *) dadda_8 dadda_4 (.A(mult4_A), .B(mult4_B), .y(mult_out_4));
    (* keep = "true" *) dadda_8 dadda_5 (.A(mult5_A), .B(mult5_B), .y(mult_out_5));
    (* keep = "true" *) dadda_8 dadda_6 (.A(mult6_A), .B(mult6_B), .y(mult_out_6));
    (* keep = "true" *) dadda_8 dadda_7 (.A(mult7_A), .B(mult7_B), .y(mult_out_7));
    (* keep = "true" *) dadda_8 dadda_8 (.A(mult8_A), .B(mult8_B), .y(mult_out_8));
