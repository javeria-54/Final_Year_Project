...
`include "single_cycle_pcore_config_defs.svh"
`include "single_cycle_csr_defs.svh"
...
typedef enum logic [4:0] {
    ...
    OPCODE_VECTOR_ARITH_INST    = 5'b10101,
    OPCODE_VECTOR_LOAD_INST     = 5'b00001,
    OPCODE_VECTOR_STORE_INST    = 5'b01001
} type_rv_opcode_e;
